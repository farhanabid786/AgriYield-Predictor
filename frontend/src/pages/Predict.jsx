...
// const API_BASE = "https://agriyield-backend-c5nc.onrender.com";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  value={form.Crop_Type}
                  onChange={handleChange}
                  className="w-full rounded-2xl border border-emerald-100 bg-emerald-50/60 px-4 py-2.5"
                >
                  {cropTypes.map((c) => (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              {[
                ...
                ["N", "Nitrogen (kg/ha)", 0, 200, 1],
                ["P", "Phosphorus (kg/ha)", 0, 200, 1],
                ["K", "Potassium (kg/ha)", 0, 200, 1],
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="rounded-full bg-emerald-600 px-6 py-2.5 text-white font-semibold hover:bg-emerald-700"
              >
                {loading ? "Predicting..." : "Predict Yield"}
              </button>
            ...
            {prediction !== null ? (
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="text-3xl font-semibold text-emerald-700">
                  {prediction.toFixed(2)}
                  <span className="text-base ml-1 text-emerald-800/80">
                    tonnes / hectare
                  </span>
                </div>
                ...
                <div className="bg-emerald-50 border border-emerald-200 p-4 rounded-xl text-sm">
                  ...
                  <p className="text-emerald-700">
                    Yield estimated using a trained Random Forest model
              ...
              <p className="mt-2 text-sm text-emerald-900/70">
                Adjust the parameters and click Predict Yield to see the result.
              </p>
